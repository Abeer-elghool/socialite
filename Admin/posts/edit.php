<?php 
  ...
  if(count($Message) == 0){
    # DB OPERATION .... 
    $admin_accept = $_POST['accept_post'] == "on";
    $sql = "update posts set title='$title' , subject= '$content' , image = '$finalImage', admin_accept = '$admin_accept' where id = ".$id;
...
?>  
 ...
 <div class="form-group">
  ...
  <div class="form-group">
   ...
   <textarea name="content" class="form-control" > <?php echo $FetchedData['subject'];?> </textarea>
  </div>

     <div class="form-group">
         <label for="exampleInputEmail1">Accept Post</label>
         <input type="checkbox" name="accept_post">
     </div>
